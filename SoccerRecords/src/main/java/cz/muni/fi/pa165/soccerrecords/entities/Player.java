...
public class Player
{
	 ...
	 * @ordered
	 */
	public void basicSetTeam(Team myTeam) {
		if (this.team != myTeam) {
			if (myTeam != null){
				if (this.team != myTeam) {
	 ...
	 * @ordered
	 */
	public void setDateOfBirth(Date myDateOfBirth) {
	 ...
	 * @ordered
	 */
	public void setDressNumber(int myDressNumber) {
		this.dressNumber = myDressNumber;
	}
	...
	public void setTeam(Team myTeam) {
		this.basicSetTeam(myTeam);
		myTeam.addPlayer(this);
	}
